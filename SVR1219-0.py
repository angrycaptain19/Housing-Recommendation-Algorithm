...
modelSVR=GridSearchCV(SVR(coef0=0.0, tol=1e-6,epsilon=0.1,shrinking=True, cache_size=2000, verbose=True, max_iter=-1,degree=3),
                    param_grid={"kernel":["rbf",],"gamma":[gamma/10000 for gamma in range(50,60)],"C":[c/10 for c in range(41,51)]},
...
vectors_weight.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/SVR1219-0.csv",
                 sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'C': 4.6, 'gamma': 0.0056, 'kernel': 'rbf'}
0.3779151787064756
score
0.3737810416970663
support_
[    6    15    19 ... 10144 10152 10154]
support_vectors_
[[ 4.48583282 -0.43788737 -0.13100248 ... -0.22395339 -0.22899927
  -0.28178096]
 [ 4.48583282 -0.43788737  0.53912152 ... -0.22395339 -0.22899927
  -0.28178096]
 [ 3.37576564 -0.06276115 -0.66710168 ... -0.22395339 -0.22899927
  -0.28178096]
 ...
 [-0.69385671 -0.81301359 -0.13100248 ... -0.22395339 -0.22899927
   3.5488558 ]
 [-0.70134452 -0.43788737  1.34327033 ... -0.22395339 -0.22899927
  -0.28178096]
 [-0.70134452 -0.43788737 -0.13100248 ... -0.22395339 -0.22899927
  -0.28178096]]
dual_coef_
[ 2.21124741  1.55560778 -1.08279628 ... -2.54980757  2.92511713
  4.6       ]
intercept_
[0.37195003]
 ...
 ...
 [-0.70134452 -0.43788737 -0.13100248 ... -0.22395339 -0.22899927
  -0.28178096]]
dual_coef_
[ 2.32501655  1.48685927 -1.10011508 ... -2.77234604  2.79591124
  4.6       ]
intercept_
[0.36999078]
"""