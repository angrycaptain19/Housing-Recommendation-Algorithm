...
modelSVR=GridSearchCV(SVR(coef0=0.0, tol=1e-6,epsilon=0.1,shrinking=True, cache_size=2000, verbose=True, max_iter=-1,degree=3),
                    param_grid={"kernel":["rbf",],"gamma":[gamma/10000 for gamma in range(111,122)],"C":[c/10 for c in range(71,82)]},
...
vectors_weight.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/SVR1219-2.csv",
                 sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'C': 7.9, 'gamma': 0.0115, 'kernel': 'rbf'}
0.2843502584906678
score
0.5217046679508771
support_
[   1    8    9 ... 3317 3318 3319]
support_vectors_
[[-0.62513949 -0.91357794 -1.08080253 ... -0.18336824 -0.21447317
  -0.28164481]
 [ 0.44385934 -0.18077321 -1.08080253 ... -0.18336824 -0.21447317
  -0.28164481]
 [ 0.35975978 -0.54717557 -0.96696166 ... -0.18336824 -0.21447317
  -0.28164481]
 ...
 [ 1.08862262  0.55203151  0.96833323 ... -0.18336824 -0.21447317
  -0.28164481]
 [-0.01775379 -0.91357794 -0.39775728 ... -0.18336824 -0.21447317
  -0.28164481]
 [ 1.06806495  0.91843387  0.28528798 ... -0.18336824 -0.21447317
  -0.28164481]]
dual_coef_
[-2.87510574  1.25195519 -2.00069828 ...  2.98732098  7.9
  0.25078783]
intercept_
[0.21504385]
"""