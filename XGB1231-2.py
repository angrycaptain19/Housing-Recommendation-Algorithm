...
modelXGB=GridSearchCV(XGBRegressor(verbosity=1, min_split_loss=0, objective='reg:squarederror',booster='gbtree',nthread=-1,gpu_id=0),
                    param_grid={"max_depth":[6],"n_estimators":range(630,671,10),"num_parallel_tree":[1],"learning_rate":[rate/100 for rate in range(10,11)],"subsample":[ratio/10 for ratio in range(6,7)], "reg_alpha":[alpha/10 for alpha in range(1,2)], "reg_lambda":[beta/10 for beta in range(12,13)],"eval_metric":["rmse"],"tree_method":["gpu_hist"],"sampling_method":["uniform"]},
...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/XGB1231-2.csv",
...
#图1：第1-2重要的变量
plot_partial_dependence(best_model, X, features[0:2], feature_names=features[0:2], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0, 1), method='auto', n_jobs=2, verbose=1, fig=None, line_kw={"c": "red"}, contour_kw=None)
fig1=plt.gcf()
fig1.suptitle("Cluster 2 with XGB Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/XGB1231-2-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
plot_partial_dependence(best_model, X, features[2:4], feature_names=features[2:4], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0, 1), method='auto', n_jobs=2, verbose=1, fig=None, line_kw={"c": "purple"}, contour_kw=None)
fig2=plt.gcf()
fig2.suptitle("Cluster 2 with XGB Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/XGB1231-2-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)

#输出预测价格
#predict_df=pd.concat([listing_data2[["Label"]],listing_data2[["id"]],listing_data2[["price"]],pd.DataFrame(modelET.predict(X),columns=["Predict"])],axis=1)
#predict_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/predict1226-2.csv",
                 #sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'eval_metric': 'rmse', 'learning_rate': 0.1, 'max_depth': 6, 'n_estimators': 650, 'num_parallel_tree': 1, 'reg_alpha': 0.1, 'reg_lambda': 1.2, 'sampling_method': 'uniform', 'subsample': 0.6, 'tree_method': 'gpu_hist'}
0.3542944342155253
score
0.9998707014045679
"""