...
listing_data0=pd.read_excel("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/listings/listings_clusters1211.xlsx",sheet_name="聚类0",header=0,names=None,verbose=True,engine="openpyxl")
print(listing_data0)
print(listing_data0.describe())
print(listing_data0.info())
print(listing_data0.dtypes)
print(listing_data0.shape)
for label in listing_data0.columns:
    print(label)
    #print(listing_data0[[label]].head(5))
    #print("Missing values: {}".format(listing_data0[[label]].isnull().sum()))
    #print("\n\n")
...
#选择X和Y的数据，并去除有缺失值的样本
XY_data=listing_data0[["host_time",
                #"first_review_to_today",
                #"last_review_to_today",
                "num_of_host_verifications",
                "num_of_amenities",
...
modelDT=GridSearchCV(DecisionTreeRegressor(),
                    param_grid={"criterion":["mae"],"splitter":["best"],'max_depth':range(18,19),"min_samples_leaf":range(15,18),"max_features":range(38,41),"min_samples_split":range(45,66,2)},
...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-0.csv",
...
#图1：第1-2重要的变量
plot_partial_dependence(best_model, X, features[0:2], feature_names=features[0:2], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0.05, 0.95), method='auto', n_jobs=4, verbose=1, fig=None, line_kw={"c": "purple"}, contour_kw=None)
fig1=plt.gcf()
fig1.suptitle("Cluster 0 with Decision Tree Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-0-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
plot_partial_dependence(best_model, X, features[2:4], feature_names=features[2:4], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0.05, 0.95), method='auto', n_jobs=4, verbose=1, fig=None, line_kw={"c": "purple"}, contour_kw=None)
fig2=plt.gcf()
fig2.suptitle("Cluster 0 with Decision Tree Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-0-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图3：决策树
fig3, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (18,12), dpi=500)
plot_tree(best_model, max_depth=None, feature_names=X_names, class_names=None, label='all', filled=True, impurity=True, node_ids=True, proportion=False, rotate='deprecated', rounded=False, precision=3, ax=None, fontsize=8)
fig3.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-0.png',dpi=500, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)

#输出预测价格
#predict_df=pd.concat([listing_data0[["Label"]],listing_data0[["id"]],listing_data0[["price"]],pd.DataFrame(modelDT.predict(X),columns=["Predict"])],axis=1)
#predict_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/predict1226-0.csv",
                 #sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'criterion': 'mae', 'max_depth': 18, 'max_features': 38, 'min_samples_leaf': 16, 'min_samples_split': 53, 'splitter': 'best'}
0.3417836559586979
classes_
None
max_features_
