...
modelDT=GridSearchCV(DecisionTreeRegressor(),
                    param_grid={"criterion":["mae"],"splitter":["best"],'max_depth':range(102,109,3),"min_samples_leaf":range(12,17,2),"max_features":range(112,119,3),"min_samples_split":range(3,8,2)},
...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-1.csv",
...
#图1：第1-2重要的变量
plot_partial_dependence(best_model, X, features[0:2], feature_names=features[0:2], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0.05, 0.95), method='auto', n_jobs=1, verbose=1, fig=None, line_kw={"c": "purple"}, contour_kw=None)
fig1=plt.gcf()
fig1.suptitle("Cluster 1 with Decision Tree Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-1-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
plot_partial_dependence(best_model, X, features[2:4], feature_names=features[2:4], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0.05, 0.95), method='auto', n_jobs=1, verbose=1, fig=None, line_kw={"c": "purple"}, contour_kw=None)
fig2=plt.gcf()
fig2.suptitle("Cluster 1 with Decision Tree Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-1-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图3：决策树
...
fig3.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-1.png',dpi=500, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)

#输出预测价格
#predict_df=pd.concat([listing_data1[["Label"]],listing_data1[["id"]],listing_data1[["price"]],pd.DataFrame(modelDT.predict(X),columns=["Predict"])],axis=1)
#predict_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/predict1226-0.csv",
                 #sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'criterion': 'mae', 'max_depth': 105, 'max_features': 112, 'min_samples_leaf': 12, 'min_samples_split': 5, 'splitter': 'best'}
0.27798474048434285
classes_
None
max_features_
