...
modelDT=GridSearchCV(DecisionTreeRegressor(),
                    param_grid={"criterion":["mse"],"splitter":["random"],'max_depth':range(50,91,2),"min_samples_leaf":range(13,18),"max_features":range(130,151,2),"min_samples_split":range(8,13)},
...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-2.csv",
...
fig1=plt.gcf()
fig1.suptitle("Cluster 2 with Decision Tree Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-2-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
...
fig2=plt.gcf()
fig2.suptitle("Cluster 2 with Decision Tree Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-2-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图3：决策树
...
fig3.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/decision_tree106-2.png',dpi=500, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)

#输出预测价格
#predict_df=pd.concat([listing_data2[["Label"]],listing_data2[["id"]],listing_data2[["price"]],pd.DataFrame(modelDT.predict(X),columns=["Predict"])],axis=1)
#predict_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/predict1226-2.csv",
                 #sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'criterion': 'mse', 'max_depth': 72, 'max_features': 140, 'min_samples_leaf': 14, 'min_samples_split': 8, 'splitter': 'random'}
0.35209026883854255
classes_
None
max_features_
