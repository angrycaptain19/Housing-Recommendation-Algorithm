...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-0.csv",
...
fig1=plt.gcf()
fig1.suptitle("Cluster 0 with Extra Trees Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-0-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
...
fig2=plt.gcf()
fig2.suptitle("Cluster 0 with Extra Trees Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-0-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
...
#打印结果摘录
"""
{'bootstrap': False, 'criterion': 'mae', 'max_depth': 35, 'max_features': 25, 'min_samples_leaf': 1, 'min_samples_split': 7, 'n_estimators': 700, 'n_jobs': 8, 'verbose': 3}
0.4131638578583206
score
0.840041939173088
"""