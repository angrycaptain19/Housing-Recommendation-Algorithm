...
modelET=GridSearchCV(ExtraTreesRegressor(),
                    param_grid={"criterion":["mae",],'bootstrap':[False],"max_features":range(5,26,5),"n_estimators":range(600,801,100),"max_depth":range(20,41,10),"min_samples_split":range(2,9,3),"verbose":[3],"n_jobs":[8],"min_samples_leaf":[1]},
...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-1.csv",
...
fig1=plt.gcf()
fig1.suptitle("Cluster 1 with Extra Trees Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-1-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
...
fig2=plt.gcf()
fig2.suptitle("Cluster 1 with Extra Trees Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-1-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)

#输出预测价格
predict_df=pd.concat([listing_data1[["Label"]],listing_data1[["id"]],listing_data1[["price"]],pd.DataFrame(modelET.predict(X),columns=["Predict"])],axis=1)
predict_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/predict1226-1.csv",
                 sep=',', na_rep='',columns=None, header=True,index=False,encoding="ANSI")

#打印结果摘录
"""
{'bootstrap': False, 'criterion': 'mae', 'max_depth': 30, 'max_features': 20, 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 700, 'n_jobs': 8, 'verbose': 3}
0.2958320433169751
score
0.7636442889258472
"""