...
modelET=GridSearchCV(ExtraTreesRegressor(),
                    param_grid={"criterion":["mse"],'bootstrap':[False],"max_features":range(82,87,2),"n_estimators":range(50,81,5),"max_depth":range(115,118),"min_samples_split":range(3,6),"verbose":[3],"n_jobs":[8],"min_samples_leaf":[1]},
...
importance_df.to_csv("E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-2.csv",
...
#图1：第1-2重要的变量
plot_partial_dependence(best_model, X, features[0:2], feature_names=features[0:2], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0, 1), method='auto', n_jobs=-1, verbose=1, fig=None, line_kw={"c": "red"}, contour_kw=None)
fig1=plt.gcf()
fig1.suptitle("Cluster 2 with Extra Trees Regressor-1")
fig1.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-2-1.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
#图2：第3-4重要的变量
plot_partial_dependence(best_model, X, features[2:4], feature_names=features[2:4], target=None, response_method='auto', n_cols=2, grid_resolution=100, percentiles=(0, 1), method='auto', n_jobs=-1, verbose=1, fig=None, line_kw={"c": "purple"}, contour_kw=None)
fig2=plt.gcf()
fig2.suptitle("Cluster 2 with Extra Trees Regressor-2")
fig2.savefig('E:/钧资料3/大学资料/课程/LN3125数据挖掘与机器学习/final project/beijing1026/extra_trees1211-2-2.png',dpi=300, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,metadata=None)
...
#打印结果摘录
"""
{'bootstrap': False, 'criterion': 'mse', 'max_depth': 113, 'max_features': 88, 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 76, 'n_jobs': 8, 'verbose': 3}
0.45893605961122413
score
0.9811413415451784
"""